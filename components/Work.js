...
function Work() {
    return (
        <div className="py-10 mx-5 md:mx-auto md:max-w-4xl" id="Work">
            ...
            <div className="mt-16 space-y-5 md:grid md:grid-cols-2 md:gap-y-4 md:gap-x-10 text-center md:mx-6">
                ...
                <WorkInfo
                    ...
                    ProjectUrl="https://rookbook-draft.vercel.app/"
                />
                ...
                <WorkInfo
                    ...
                    ProjectUrl="https://amazon-clone-2-0-cyan.vercel.app/"
                />
                ...
                <WorkInfo
                    ...
                    ProjectUrl="https://hulu-clone-omega-one.vercel.app/"
                />
                ...
                <WorkInfo
                    ...
                    ProjectUrl="https://linkedin-clone-4c93e.web.app/"
                />

                <WorkInfo
                    ImageUrl="https://i.imgur.com/rB6apgn.png"
                    Title="E-COMMERCE APPLICATION"
                    Text="A basic e-Commerce Application that serves the purpose of selling succulents. Built and developed using Flutter, Dart, Google Authentiction and Firestore."
                    ProjectUrl=""
                />
            </div>
        </div>

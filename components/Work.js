function Work() {
    return (
        <div className="py-20 mx-10 md:mx-auto md:max-w-4xl">
            ...
            <div className="mt-20 space-y-10 md:grid md:grid-cols-2 md:grid-rows-4 md:gap-4 text-center">
                <div className="col-span-2 bg-white shadow">
                    ...
                    <div className="py-6 px-4 md:px-8 text-sm text-left font-karla bg-blue-500">
                        <p>

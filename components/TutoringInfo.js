            ...
            {orientation == "left" ? (
                <div className="md:grid md:grid-cols-2 md:gap-x-10">
                    ...
                    <div className="mt-5 flex flex-col items-center justify-center">
                        <h2 className="text-xs font-merriweather self-start">
                            {language}
                        </h2>
                        <h1 className="text-3xl font-bold font-merriweather self-start">
                            {project}
                        </h1>
                        <hr
                            className="border border-t-2 border-gray-300 my-5 self-start"
                            width="40%"
                        />
                        <p className="text-sm">{description}</p>
                        <button className="p-2 px-6 bg-black text-white mt-8">
                            <a href="https://drive.google.com/uc?export=download&id=1YmMTpPQej9B9j06h6UksiW5FglLDZHvW">
                                Download Game Files
                            </a>
                        </button>
                    </div>
